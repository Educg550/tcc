...
Esperado: os sete campos aparecem com os rótulos exatos e há um botão `Enviar solicitação`.

## C2 — solicitação válida gera o ofício
...
valor `R$ 1.500,00`. Clicar em `Enviar solicitação`.
...
## C3 — campo obrigatório vazio é barrado
...
## C4 — N. USP não numérico é barrado
